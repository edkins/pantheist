...
import io.pantheist.handler.filekind.backend.HandlerFileKindBackendModule;
...
import io.pantheist.handler.plugin.backend.HandlerPluginBackendModule;
...
public class AllPantheistModule extends AbstractModule
{
	...
	protected void configure()
	{
		...
		install(new HandlerFileKindBackendModule());
		...
		install(new HandlerPluginBackendModule());
