...
@Path("/")
public final class JavaResourceImpl implements JavaResource
{
	private static final Logger LOGGER = LogManager.getLogger(JavaResourceImpl.class);
	private final JavaBackend backend;
	private final Resp resp;

	@Inject
	private JavaResourceImpl(final JavaBackend backend, final Resp resp)
	{
